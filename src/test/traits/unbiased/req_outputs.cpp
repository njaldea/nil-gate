...
TEST(gate_node_req_outputs, traits_unique_ptr)
{
    ...
    }
    {
        ...
        ASSERT_TRUE(type::is_valid);
        ASSERT_TRUE(type::size == 1);
        ASSERT_TRUE((std::is_same_v<type::ports, req_outputs<std::unique_ptr<int>>>));
    }
    {
...
TEST(gate_node_req_outputs, traits_shared_ptr)
{
    ...
    }
    {
        ...
        ASSERT_TRUE(type::is_valid);
        ASSERT_TRUE(type::size == 1);
        ASSERT_TRUE((std::is_same_v<type::ports, req_outputs<std::shared_ptr<int>>>));
    }
    {
...
TEST(gate_node_req_outputs, traits_optional)
{
    ...
    }
    {
        ...
        ASSERT_TRUE(type::is_valid);
        ASSERT_TRUE(type::size == 1);
        ASSERT_TRUE((std::is_same_v<type::ports, req_outputs<std::optional<int>>>));
    }
    {
...
TEST(gate_node_req_outputs, traits_ref_wrapper)
{
    ...
    }
    {
        ...
        ASSERT_TRUE(type::is_valid);
        ASSERT_TRUE(type::size == 1);
        ASSERT_TRUE((std::is_same_v<type::ports, req_outputs<std::reference_wrapper<int>>>));
    }
    {
