...
TEST(gate_node_inputs, traits_unique_ptr)
{
    ...
    }
    {
        ...
        ASSERT_TRUE(type::is_valid);
        ASSERT_TRUE(type::size == 1);
        ASSERT_TRUE((std::is_same_v<type::ports, inputs<const std::unique_ptr<int>*>>));
    }
    {
        using type = SUT<types<const std::unique_ptr<int>&>>;
        ASSERT_TRUE(type::is_valid);
        ASSERT_TRUE(type::size == 1);
        ASSERT_TRUE((std::is_same_v<type::ports, inputs<std::unique_ptr<int>>>));
    }
    {
...
TEST(gate_node_inputs, traits_shared_ptr)
{
    ...
    }
    {
        ...
        ASSERT_TRUE(type::is_valid);
        ASSERT_TRUE(type::size == 1);
        ASSERT_TRUE((std::is_same_v<type::ports, inputs<std::shared_ptr<int>>>));
    }
    {
    ...
    }
    {
        ...
        ASSERT_TRUE(type::is_valid);
        ASSERT_TRUE(type::size == 1);
        ASSERT_TRUE((std::is_same_v<type::ports, inputs<const std::shared_ptr<int>*>>));
    }
    {
        using type = SUT<types<const std::shared_ptr<int>&>>;
        ASSERT_TRUE(type::is_valid);
...
TEST(gate_node_inputs, traits_optional)
{
    ...
    }
    {
        ...
        ASSERT_TRUE(type::is_valid);
        ASSERT_TRUE(type::size == 1);
        ASSERT_TRUE((std::is_same_v<type::ports, inputs<std::optional<int>>>));
    }
    {
    ...
    }
    {
        ...
        ASSERT_TRUE(type::is_valid);
        ASSERT_TRUE(type::size == 1);
        ASSERT_TRUE((std::is_same_v<type::ports, inputs<const std::optional<int>*>>));
    }
    {
        using type = SUT<types<const std::optional<int>&>>;
        ASSERT_TRUE(type::is_valid);
...
TEST(gate_node_inputs, traits_ref_wrapper)
{
    ...
    }
    {
        ...
        ASSERT_TRUE(type::is_valid);
        ASSERT_TRUE(type::size == 1);
        ASSERT_TRUE((std::is_same_v<type::ports, inputs<std::reference_wrapper<int>>>));
    }
    {
    ...
    }
    {
        ...
        ASSERT_TRUE(type::is_valid);
        ASSERT_TRUE(type::size == 1);
        ASSERT_TRUE((std::is_same_v<type::ports, inputs<const std::reference_wrapper<int>*>>));
    }
    {
        using type = SUT<types<const std::reference_wrapper<int>&>>;
        ASSERT_TRUE(type::is_valid);
