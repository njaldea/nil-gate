...
TEST(gate, traits_empty)
{
    ...
    ASSERT_TRUE((std::is_same_v<type::outputs::edges, void>));
...
TEST(gate, traits_sync_output)
{
    { // ok cases
        ...
        ASSERT_TRUE((std::is_same_v<type::outputs::sync_t, expected_t>));
...
TEST(gate, traits_async_output)
{
    { // ok cases
        ...
        ASSERT_TRUE((std::is_same_v<type::outputs::async_t, expected_t>));
