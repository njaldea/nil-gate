...
#define nil_gate_port_set_value(PORT, VALUE)                                                                            \
    _Generic((PORT), struct nil_gate_mport: nil_gate_mport_set_value, struct nil_gate_bport: nil_gate_bport_set_value)( \
        PORT,                                                                                                           \
        VALUE                                                                                                           \
    )
#define nil_gate_port_unset_value(PORT)                                                                                     \
    _Generic((PORT), struct nil_gate_mport: nil_gate_mport_unset_value, struct nil_gate_bport: nil_gate_bport_unset_value)( \
        PORT                                                                                                                \
    )
