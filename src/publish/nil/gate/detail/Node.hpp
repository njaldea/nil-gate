...
namespace nil::gate
{
    ...
    {
    public:
        using base_t = Node<xalt::tlist<I...>, xalt::tlist<P...>>;
        virtual std::tuple<ports::Compatible<traits::portify_t<std::decay_t<I>>>...>& inputs() = 0;
...
namespace nil::gate::detail
{
    ...
    class Node final
        : public gate::Node<
              typename detail::traits::node<T>::inputs::port_types,
              typename detail::traits::node<T>::outputs::port_types>
    {
    ...
    public:
        Node(Core* init_core, T init_instance, typename input_t::ports init_inputs)
            : core(init_core)
        ...
        // called by (input) port to remove itself
